...
export function canCraft(recipe: Recipe, state: GameState): CraftOutcome {
...
export function applyCraft(recipe: Recipe, state: GameState): CraftOutcome {
  const check = canCraft(recipe, state);
