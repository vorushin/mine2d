...
export class GameOverScene extends Phaser.Scene {
  ...
  create(data: { score: number; stats?: RunStats }): void {
    ...
    const btn = this.add.rectangle(w / 2, h / 2 + 160, 220, 48, 0x3a7a3a).setStrokeStyle(2, 0x88ff88, 0.7);
    this.add.text(w / 2, h / 2 + 160, '▶  Try Again', {
    ...
    const menuBtn = this.add.rectangle(w / 2, h / 2 + 220, 160, 36, 0x26334a).setStrokeStyle(1, 0x88aaff, 0.6);
    this.add.text(w / 2, h / 2 + 220, 'Main Menu', {
