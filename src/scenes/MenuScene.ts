...
export class MenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    const btn = this.add.rectangle(w / 2, h / 2 + 20, 240, 58, 0x3a7a3a).setStrokeStyle(3, 0x88ff88, 0.85);
    this.add.text(w / 2, h / 2 + 20, '▶  Start Run', { fontFamily: 'system-ui', fontSize: '24px', color: '#fff', fontStyle: 'bold' }).setOrigin(0.5);
